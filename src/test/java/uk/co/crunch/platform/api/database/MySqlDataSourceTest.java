...
public class MySqlDataSourceTest {
    ...
    public void testLongForm() throws NoSuchMethodException {
        ...
        assertThat( getDbConnectionUrl(ann) ).isEqualTo("root:mysql@tcp(rds-wordpress.x.y:3306)/");
    ...
    public void testLongFormReadOnly() throws NoSuchMethodException {
        ...
        assertThat( getDbConnectionUrl(ann) ).isEqualTo("root:mysql@tcp(rds.service.consul:3306)/");
